...
mods.artisanworktables.Worktable.addRecipeShaped("engineer", <minecraft:piston>*2, <ore:engineers_wrench>, 20, true, [[<ore:plankWood>, <ore:plankWood>, <ore:plankWood>], [<ore:compressed1xCobblestone>, <ore:gearSteel>, <ore:compressed1xCobblestone>], [<ore:compressed1xCobblestone>, <contenttweaker:red_fiber>, <ore:compressed1xCobblestone>]]);
