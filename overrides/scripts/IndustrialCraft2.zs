...
recipes.addShaped("IC2Recipe05", <ic2:te:46>, [[<betterwithaddons:wrought_bars>, <ore:plateIron>, <betterwithaddons:wrought_bars>], [<ore:plateIron>, <minecraft:furnace>, <ore:plateIron>], [<betterwithaddons:wrought_bars>, <ore:plateIron>, <betterwithaddons:wrought_bars>]]);

#Macerator
recipes.remove(<ic2:te:47>);
recipes.addShaped("IC2Recipe06", <ic2:te:47>, [[<ore:gemDiamond>, <ore:gemDiamond>, <ore:gemDiamond>], [<ore:plateSteel>, <ic2:resource:12>, <ore:plateSteel>], [null, <ic2:crafting:1>, null]]);

#Thermal Centrifuge
recipes.remove(<ic2:te:52>);
recipes.addShaped("IC2Recipe07", <ic2:te:52>, [[<ic2:plate:16>, <forestry:centrifuge>, <ic2:plate:16>], [<ic2:mining_laser>, <genetics:misc:10>, <ic2:mining_laser>], [<ic2:plate:16>, <ic2:te:54>, <ic2:plate:16>]]);

#Machine Casing
recipes.remove(<ic2:resource:12>);
recipes.addShaped("IC2Recipe08", <ic2:resource:12>, [[<ore:plateAluminum>, <ore:plateAluminum>, <ore:plateAluminum>], [<ore:plateAluminum>, null, <ore:plateAluminum>], [<ore:plateAluminum>, <ore:plateAluminum>, <ore:plateAluminum>]]);
