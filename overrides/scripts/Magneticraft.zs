...
recipes.addShaped("MagnetRecipe02", <magneticraft:crafting:3>*8, [[<magneticraft:copper_coil>, <magneticraft:copper_coil>, <magneticraft:copper_coil>], [<magneticraft:copper_coil>, <contenttweaker:advanced_spool>, <magneticraft:copper_coil>], [<magneticraft:copper_coil>, <magneticraft:copper_coil>, <magneticraft:copper_coil>]]);
